...
if (edad < EDAD_MINIMA){
  console.log("No tienes la edad mínima para continuar con el procedimiento.");
} else if ( edad > EDAD_MAXIMA){
  console.log("El rango de edad ingresado no está permitido.");
} else {
   console.log("Tu edad te permite continuar en el procedimiento.")
}
